...
@Autonomous(name = "Red Far Leviathan CTS", group = "Autonomous", preselectTeleOp = "TeleOp")
public class RedFarLeviathanCTS extends OpMode {
    ...
    public void buildPaths() {
        ...
        // Spike mark sweep (unchanged geometry)
    ...
    public void autonomousPathRedUpdate() {
        switch (pathState) {
            ...
            // pathTimer gives the intake time to grab rings while the robot
            // is still moving; follower.isBusy() prevents early exit.
            case 2:
            ...
            case 3:
                ...
                if (shooterTimer.getElapsedTime() > SHOOT_DURATION_MS) {
                    ...
                    setPathState(10); // enter the HPZ loop
                }
                break;

            // ══════════════════════════════════════════════════════════════════
            // HPZ LOOP
            // State 10: travel to HPZ and collect
            // State 11: return to score and shoot
            // After shooting, loop back to 10 — unless time is almost up,
            // in which case go park (state 20).
            // ══════════════════════════════════════════════════════════════════
    ...
    public void loop() {
        ...
        telemetry.addLine("RED Far Leviathan");
