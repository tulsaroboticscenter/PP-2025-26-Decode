...
/** @noinspection ALL*/
@Disabled
@TeleOp(name="TeleBlueDebug", group="Robot")
public class SauronBlueDebug extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        robot.turretRotationMotor.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
