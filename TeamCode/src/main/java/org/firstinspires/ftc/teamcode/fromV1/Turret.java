...
public class Turret {
    ...
    {
        turretPID.setTarget(HeadingToTurretTicks(org.firstinspires.ftc.teamcode.Libraries.Targeting.getDegreesToTarget(currentPosition, targetPosition, false), AngleUnit.DEGREES));
    }
