...
public class Field {
     ...
     **/
        ...
        public static final Pose2D blueGoalLocal = new Pose2D(DistanceUnit.INCH, 67, 129, AngleUnit.DEGREES, 0);
        public static final Pose2D redGoalLocal = new Pose2D(DistanceUnit.INCH, -67, 65, AngleUnit.DEGREES, 0);        public static final Pose2D blueHumanPlayerZone = new Pose2D(DistanceUnit.INCH, 136.5, 7.7, AngleUnit.DEGREES, 90);
