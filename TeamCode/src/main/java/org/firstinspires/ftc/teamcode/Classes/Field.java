...
public class Field {
     ...
     **/
        ...
        // Points of Interest
        public static final Pose2D blueGoal = new Pose2D(DistanceUnit.INCH, 10, 137, AngleUnit.DEGREES, 0);
        public static final Pose2D redGoal = new Pose2D(DistanceUnit.INCH, 134, 137, AngleUnit.DEGREES, 0);
        public static final Pose2D blueHumanPlayerZone = new Pose2D(DistanceUnit.INCH, 136.5, 9, AngleUnit.DEGREES, 90);
        public static final Pose2D redHumanPlayerZone = new Pose2D(DistanceUnit.INCH, 7.5, 9, AngleUnit.DEGREES, 90);
