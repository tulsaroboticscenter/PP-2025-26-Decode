...
public class FieldMarkers {
     ...
     **/
        ...
        public Pose2D redHumanPlayer = new Pose2D(DistanceUnit.INCH, -54, -54, AngleUnit.DEGREES, 0);
        public Pose2D blueHumanPlayer = new Pose2D(DistanceUnit.INCH, 54, -54, AngleUnit.DEGREES, 0);
