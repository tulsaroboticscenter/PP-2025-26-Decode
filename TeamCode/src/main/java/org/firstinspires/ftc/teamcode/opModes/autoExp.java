...
@Autonomous(name = "Auto Experimental (Blue)", group = "Robot", preselectTeleOp = "SauronBlue")
public class autoExp extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            target.rotateToTarget(goalPosition, 1);
